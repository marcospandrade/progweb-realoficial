                ...
                <div class="row al-center">
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="./../../img/portfolio/BeloHorizonte.jpg" alt="Belo Horizonte">
                        </a>
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="./../../img/portfolio/CidadeSalvador.jpg" alt="">
                        </a>
                        <div class="portfolio-caption">
                            <h4>Salvador</h4>
                            ...
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Viagem para Belo Horizonte no valor de R$ 160,00
                                        reais.</p>
                                    <img class="img-fluid d-block mx-auto" src="./../../img/portfolio/BeloHorizonte.jpg"
                                        alt="">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="./../../img/portfolio/CidadeSalvador.jpg"
                                        alt="">
                                    <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos
                                        deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate,
...
import NavRight from '@/js/components/layout/NavRight';
